function code = expBucklin_Infinite_laser
...
if ismember(vr.laser.currFrame,vr.laser.frameOn)
    disp('FIRE!');
    vr.vrSystem.rewardPulseObj.outputSingleScan(5); % (set high)
end
...
% mike commented out the following lines	
