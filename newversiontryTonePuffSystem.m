classdef TonePuffSystem < SubSystem
   ...
   methods % SETUP
	  ...
	  function createSystemComponents(obj)
		 ...
		 % 		 obj.trialTriggerSession.addTriggerConnection([obj.daqDeviceName,'/','PFI0'], 'External', 'StartTrigger');
		 ...
		 obj.stimOutSession.addTriggerConnection('External', frameClkString, 'StartTrigger');
		 ...
		 obj.frameCountSession.addClockConnection('External', [obj.daqDeviceName,'/','Ctr0InternalOutput'], 'ScanClock');		 		
   ...
   methods % TONE-PUFF SPECIFIC
	  ...
	  function loadNextStimFcn(obj,src,evnt)
		 obj.stimOutSession.queueOutputData(obj.stimulusSet{obj.currentStimulusNumber});
		 prepare(obj.stimOutSession);
